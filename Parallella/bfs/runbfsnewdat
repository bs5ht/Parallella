...
echo "---------------------------------"
echo "64 nodes"
sudo EPIPHANY_HDF=$EPIPHANY_HDF LD_LIBRARY_PATH=$LD_LIBRARY_PATH PATH=$PATH ./bfs data/graph64.txt
echo "---------------------------------"
echo "128 nodes"
sudo EPIPHANY_HDF=$EPIPHANY_HDF LD_LIBRARY_PATH=$LD_LIBRARY_PATH PATH=$PATH ./bfs data/graph128.txt
echo "256 nodes"
sudo EPIPHANY_HDF=$EPIPHANY_HDF LD_LIBRARY_PATH=$LD_LIBRARY_PATH PATH=$PATH ./bfs data/graph256.txt
echo "512 nodes"
sudo EPIPHANY_HDF=$EPIPHANY_HDF LD_LIBRARY_PATH=$LD_LIBRARY_PATH PATH=$PATH ./bfs data/graph512.txt
echo "---------------------------------"
echo "1k nodes"
